...
def pcl_callback(pcl_msg):
    ...
    for index, pts_list in enumerate(cluster_indices):
        ...
        #file_name = str(index)+"_cloud.pcd"
        #pcl.save(pcl_cluster, file_name)
...
def pr2_mover(object_list):
    ...
    # calculate centroid of the clusters
    labels = []
    centroids = []
    ...
    for d in dropbox_param:
        dropbox_dict[d['group']] = d['position']
    ...
    for obj in xrange(len(object_list_param)):

        # name
        object_name.data = object_list_param[obj]['name']
        ...
        # select the arm
        group_color = object_list_param[obj]['group']
        if group_color == 'green':
            arm_name.data = 'right'
        ...
        # populate place_pose
        place_pose.position.x = dropbox_dict[group_color][0]
        place_pose.position.y = dropbox_dict[group_color][1]
        place_pose.position.z = dropbox_dict[group_color][2]
